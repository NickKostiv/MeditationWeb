  ...
  return (
    <div className="relative font-geometria bg-black py-4 md:pt-[58px] px-[20px] md:px-[40px] lg:px-[130px]">
      ...
      <div className="flex flex-col w-full max-w-[1920px]">
        <h1 className="text-[28px] md:text-[35px] text-center font-bold uppercase text-transparent bg-clip-text bg-gradient-to-r from-[#02488d] to-[#27e2ef] leading-[1.6em] tracking-[0.02em] mt-[15px] md:mt-10 font-geometria">
        ...
        <div className="flex items-center justify-center space-x-1 lg:space-x-4 mt-[30px]">
          <Link
            href="/BREATHING"
            className="text-[#27e2ef]  lg:text-[21px] font-thin text-[16px] uppercase md:tracking-[0.1em] hover:opacity-80">
            BREATHING
          </Link>
        ...
        <div className="flex flex-col text-start text-white lg:w-[60%] mt-[20px] font-geometria">
          ...
          <p className="mt-[20px] text-[20px] leading-[32px] font-thin">
        ...
        <TestimonialsBlock />
        <div className="flex flex-col items-center justify-center mt-[30px] w-full max-w-[650px] py-[40px] px-[30px] md:px-[60px] bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat rounded-[21px]">
          <h2 className="text-white text-center font-normal text-[23px] md:text-[26px] leading-[28px]  md:leading-[30px]">
            Are your chakras balanced? Take <br /> our quiz on Slowdive and
            uncover your spiritual harmony.{" "}
          </h2>
          <Link
            href="/QuizPage"
            className="flex items-center justify-center text-center mt-[15px] py-[8px] px-[30px] border-[2px] border-white hover:bg-gray-400 hover:bg-opacity-45 hover:border-transparent transition-all duration-300 rounded-[21px] relative group">
            <span className="text-white text-[20px]">Explore more</span>
            <div className="flex items-center justify-center opacity-0 transform translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
              <Image
                src={NextArrow}
                width={20}
                height={20}
        ...
        <div className="flex xl:hidden w-full mt-[30px] max-w-[650px] flex-col text-white bg-[#062327] py-[20px] px-[20px] rounded-[21px]">
          <Image
            src={Logo}
            alt="logo"
            className="w-full max-w-[50px] h-[50px] min-h-[50px] mr-auto"
          ...
          <Image
            ...
            className="mt-[20px]"
          />
          <p className="mt-[15px] text-[20px] font-thin">
            Our goal is to guide you through each phase of your mindfulness
            path. We aim to help you embrace tranquility, breathe deeply, and
            forge a deeper connection with yourself.
          </p>
          <p className="mt-[15px] text-[20px] font-thin">
            ...
            to unlock the secrets of mindfulness, immerse yourself in Sleep
            Stories, choose music that matches your mood, or engage in a calming
            breathing exercise.
          </p>
        </div>
