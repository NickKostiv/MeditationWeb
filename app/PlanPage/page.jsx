...
export default function PlanPage({ onContinue }) {
  return (
    <div className="">
      <div className="relative bg-[radial-gradient(77.28%_53.46%_at_80.97%_37.09%,rgb(12,38,18)_0%,rgb(8,1,19)_100%)] flex flex-col items-center  md:justify-start  text-white">
          ...
          <div className="flex-col w-full max-w-[550px] mt-[40px] font-montserrat">
            ...
            <div className="flex mt-[30px]">
              ...
              <div className="flex-col  ml-[20px] text-white my-auto">
                ...
                <p className="text-[15px] md:text-[18px]  font-thin leading-[18px]">
                  These meditations are an excellent starting point for
                  beginners
                </p>
              </div>
            </div>
            ...
            <div className="flex mt-[30px]">
              ...
              <div className="flex-col  ml-[20px] text-white my-auto">
                ...
                <p className="text-[15px] md:text-[18px]  font-thin leading-[18px]">
                  Breathwork can reduce stress, anxiety, fatigue, can improve
                  lung function, focus, and sleep
                </p>
              </div>
            </div>
            <div className="flex mt-[30px]">
        ...
        <div className="bg-[radial-gradient(77.28%_53.46%_at_80.97%_37.09%,rgb(12,38,18)_0%,rgb(8,1,19)_100%)] px-[20px] pb-[0px]">
        ...
        <div className="w-full max-w-[550px] bg-[#4646464d] sticky bottom-0 left-0 right-0 z-30 text-right p-4 rounded-t-[30px]">
          <button
            className="relative w-full inline-flex mx-auto items-center justify-center bg-[#2fd1db] text-white text-[20px] font-semibold uppercase leading-[18px] py-[16px] px-5 rounded-[64px] shadow-none transition-transform duration-300 ease-in-out focus:outline-none active:scale-90"
            onClick={onContinue}>
            CONTINUE
          </button>
        </div>{" "}
