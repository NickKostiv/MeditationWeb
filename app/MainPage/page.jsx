      ...
      <section className={`${montserrat.className} relative h-screen w-full`}>
        ...
        <div className="relative z-10 flex flex-col justify-end pb-[200px] items-center md:justify-center md:pb-0 text-center text-white h-full">
          ...
          <button
            ...
            className=" w-full max-w-[250px] md:max-w-[248px] backdrop-blur-[5px] bg-white/5 border border-white rounded-[50px] tracking-[3.2px] mt-[42px] opacity-100 md:opacity-70 uppercase hover:text-white hover:opacity-100 transition-all duration-[600ms] ease-in-out">
            <p className="px-[12px] py-[14px] text-[12px] font-normal text-white">
              Start Your Journey
            </p>
          </button>
        </div>
